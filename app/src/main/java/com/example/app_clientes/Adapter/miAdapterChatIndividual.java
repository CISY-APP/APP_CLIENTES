...
public class miAdapterChatIndividual  extends RecyclerView.Adapter<miAdapterChatIndividual.ExampleViewHolder> {
    ...
    public miAdapterChatIndividual(Context c) {
        this.c = c;
    }
    ...
    public miAdapterChatIndividual.ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case OWN_MESSAGE_TYPE: {
                View v = LayoutInflater.from(c).inflate(R.layout.item_mensajes_enviados, parent,false);
                return new miAdapterChatIndividual.OwnViewHolder(v);
            }

            case DEFAULT_MESSAGE_TYPE:
            default: {
                View v = LayoutInflater.from(c).inflate(R.layout.item_mensajes_recibidos, parent, false);
                return new miAdapterChatIndividual.DefaultViewHolder(v);
            }
        }
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull miAdapterChatIndividual.ExampleViewHolder holder, int position) {
    ...
    class OwnViewHolder extends miAdapterChatIndividual.ExampleViewHolder {
    ...
    class DefaultViewHolder extends miAdapterChatIndividual.ExampleViewHolder {
