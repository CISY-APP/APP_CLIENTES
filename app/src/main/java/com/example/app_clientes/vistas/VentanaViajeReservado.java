...
public class VentanaViajeReservado extends AppCompatActivity implements View.OnClickListener{
    //Atributos XML:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventana_viaje_reservado);
        mensaje=findViewById(R.id.textViewMensajeViajeReservado);
        btOK =findViewById(R.id.btListoViajeReservado);
