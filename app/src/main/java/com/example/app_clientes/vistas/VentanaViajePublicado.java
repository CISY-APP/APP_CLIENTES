...
public class VentanaViajePublicado extends AppCompatActivity implements View.OnClickListener{
    //Atributos XML:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventana_viaje_publicado);
        //Vinculamos los atributos de la clase:
        mensaje=findViewById(R.id.textViewMensajeViajePublicado);
        btOK =findViewById(R.id.btListoViajePublicado);
