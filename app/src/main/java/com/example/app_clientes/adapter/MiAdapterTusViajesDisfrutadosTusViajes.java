...
//Clase adapter de viajes publicados - usuarios:
public class MiAdapterTusViajesDisfrutadosTusViajes extends RecyclerView.Adapter<MiAdapterTusViajesDisfrutadosTusViajes.ExampleViewHolder> {
    ...
    public interface OnItemClickListener {
        void OnUsuarioClick(int position);      //Metodo abstracto que abre chat con el usuario pulsado.
        void OnUsuarioLongClick(int position);  //Metodo abstracto para cuando el usuario haga click largo se borre a este usuario de la reserva.
    }
